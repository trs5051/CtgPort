...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable( {
        buttons: [
            ...
            //             .css( 'font-size', '14px' )
            //             .prepend(
            //                 '<div class="header" style="display:flex;justify-content:space-between;align-item:center;font-size:14px;"><div id="adm-logo" class="left"><img src="http://localhost:8000/assets/admins/images/logo-1.png" class="img-fluid" alt="logo" width="100" height="100" /></div><div><h3 style="text-align: center">Chittagong Port Authority <br/>Office of the Director (Security) <br/>Bandar, Chittagong-4100</h3> <h3 style="text-align: center">Invoice List</h3></div><div class="adm-logo right"></div>    </div>'
            //             );
 
            //         $(win.document.body).find( 'table' )
            //             .addClass( 'compact cell-border' )
            //             .css( {"border-collapse": "collapse",  "font-size": "14px"} );
            //         $(win.document.body).find('td','th').addClass('display').css( {"text-align": "center",  "font-size": "14px"})
            //         ;
            //     }
            // },
            {
    ...
    // Moving print button to title warp
    $(".print-p").prependTo("#adm-main-content .panel-heading .dt-buttons.btn-group").css('display', 'inline-block');
...
function PrintIt_allpage(img_logo) {  
